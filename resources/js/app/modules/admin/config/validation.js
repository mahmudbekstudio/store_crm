...
export default {
    ...
    isEmail: function(field) {
        return v => constants.VALIDATION_EMAIL.test(v) || i18n.t('locale.validation.field_must_be_valid', {field})
    },
    in: function (field, list) {
        return v => (v && list.indexOf(v) > -1) || i18n.t('locale.validation.field_must_be_in_the_list', {field, list: list.join('", "')})
    },
    notIn: function(field, list) {
        return v => (v && list.indexOf(v) == -1) || i18n.t('locale.validation.field_must_not_be_in_the_list', {field, list: list.join('", "')})
    }
}